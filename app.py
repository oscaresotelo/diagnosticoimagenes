...
if uploaded_image is not None:
    ...
    prompt = 'realizar diagnostico medico detallado de la imagen, y el posible tratamiento relacionado solo a la imgagen , y en el caso de necesitar medicamentos , especificar cuales'
